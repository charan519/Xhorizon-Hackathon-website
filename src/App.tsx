                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="flex-1">
                    <motion.div
                      whileHover={{ scale: 1.1, rotateY: 180 }}
                      transition={{ duration: 0.6 }}
                      className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center mb-4 mx-auto md:mx-0"
                    >
                      <img 
                        src="https://cis.ieee.org/images/files/Branding/logos/white/IEEE_CIS_logo_White_RGB_300ppi.png" 
                        alt="IEEE CIS Logo"
                  ...
                  <div className="flex-[2] text-center md:text-left">
                    <h3 className="text-2xl font-bold mb-2">IEEE CIS Recognition</h3>
                    <p className="text-4xl font-bold text-blue-400 mb-4">Certificate of Appreciation</p>
                    <p className="text-gray-400">Awarded to one outstanding team from each track</p>
                  </div>
                </div>
              </div>
            </motion.div>

            {/* AWS Cloud Club Special Prize */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="mt-12 relative"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 via-yellow-500/20 to-orange-500/20 rounded-2xl blur-xl"></div>
              <div className="relative border border-white/10 rounded-2xl backdrop-blur-sm p-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="flex-1">
                    <motion.div
                      whileHover={{ scale: 1.1, rotateY: 180 }}
                      transition={{ duration: 0.6 }}
                      className="w-20 h-20 rounded-full bg-gradient-to-br from-yellow-400/20 to-orange-500/20 flex items-center justify-center mb-4 mx-auto md:mx-0"
                    >
                      <img 
                        src="https://media.konfhub.com/past_events/2024/August/28/1724879519122-86e4a31a-7dd3-4ec7-94a6-5ba169b25237.png" 
                  ...
                  <div className="flex-[2] text-center md:text-left">
                    <h3 className="text-2xl font-bold mb-2">AWS Cloud Credits</h3>
                    <p className="text-4xl font-bold text-yellow-400 mb-4">$75 Credits</p>
                    <p className="text-gray-400">AWS credit vouchers awarded to three innovative teams</p>
                  </div>
                </div>
              </div>
            </motion.div>
